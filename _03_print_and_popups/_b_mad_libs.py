...
if __name__ == '__main__':
    ...
    messagebox.showinfo(title='hi',message='If you find your self having to cross a piranha infested river, heres how to do it')
    # Get the player to enter an adjective
    adjective = simpledialog.askstring(title='hi',prompt='enter an adjective')
    # Get the player to enter a type of liquid
    liquid = simpledialog.askstring(title='hi',prompt='enter a body of water')
    # Get the player to enter a body part
    body = simpledialog.askstring(title='hi',prompt='enter a body part')
    # Get the player to enter a verb
    verb = simpledialog.askstring(title='hi',prompt='enter a verb')
    # Get the player to enter a place
    place = simpledialog.askstring(title='hi',prompt='enter a place')
